    ...
    public partial class BellUI : UserControl
    {
        ...
        private void add_new_bill_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (registr_radio.Checked == true)
                {
                    car.set_car_number(re_number.Text);
                }
                else
                {
                    car.set_car_number(car_num_bill.Text);
                    car.set_car_number(car_num_bill.Text);
                    ...
                    car_command.Parameters.AddWithValue("@car_number", car.get_car_number());
                ...
                cmd.Parameters.AddWithValue("@car_number", car.get_car_number());
